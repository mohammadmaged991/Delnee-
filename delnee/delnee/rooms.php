    ...
    <div class="container-xxl bg-white p-0">
      ...
      <div class="container-xxl py-5">
        <div class="container">
          ...
          <div class="row">
  <?php
    // Fetch and render the rooms dynamically
    if (isset($rooms) && count($rooms) > 0) {
        foreach ($rooms as $room) {
          $imageData = $room['image'];
          ...
          if ($imageData) {
            $imageType = 'image/jpg'; // Assuming the BLOB data is a JPEG
            echo '<img src="data:' . $imageType . ';base64,' . base64_encode($imageData) . '" max-width="500px" height="168px" alt="Image of ' . htmlspecialchars($room['name']) . '">';
          } else {
            echo '<img src="img/default.jpg" width="100%" height="168px" alt="Image not available">';
          }            
           echo '      <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">$' . htmlspecialchars($room['price_per_night']) . '/Night</small>';
          echo '    </div>';
          echo '    <div class="p-4 mt-2">';
          echo '      <div class="d-flex justify-content-between mb-3">';
          echo '        <h5 class="mb-0">' . htmlspecialchars($room['name']) . '</h5>';
          echo '      </div>';
          echo '      <div class="d-flex mb-3">';
          echo '        <small class="border-end me-3 pe-3">';
          echo '          <i class="fa fa-bed text-primary me-2"></i>' . htmlspecialchars($room['number_of_bed']) . ' Bed</small>';
          echo '        <small class="border-end me-3 pe-3">';
          echo '          <i class="fa fa-bath text-primary me-2"></i>' . htmlspecialchars($room['number_of_bath']) . ' Bath</small>';
          echo '        <small>';
          echo '          <i class="fa fa-wifi text-primary me-2"></i> Wifi </small>';
          echo '      </div>';
          echo '      <div class="book-now">';
          echo '        <a class="btn btn-sm btn-warning text-white rounded py-2 px-4" href="form.php?room_id=' . $room['id'] . '">Book Now</a>';
          echo '      </div>';
          echo '    </div>';
          echo '  </div>';
          echo '</div>';
        ...
        echo '<p class="text-center">No rooms available for this hotel.</p>';
    }
  ?>
</div>
