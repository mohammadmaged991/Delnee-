...
<html lang="en">
  ...
  <body>
    <div class="container-xxl bg-white p-0">
      ...
      <div class="container-fluid bg-dark px-0">
                  ...
                  <div class="row g-2">
                    <div class="col-md-12">
                      <select class="form-select" id="countryDropdown" onchange="fetchPlaces()">
                        ...
                        <option value="31">United Arab Emiratesis</option>
                        <option value="32">Bahrain</option>
                        <option value="33">Sudan</option>
                        <option value="34">Qatar</option>
                        <option value="35">Kowait</option>
                        <option value="36">Oman</option>
                        <option value="37">Moritania</option>
                      </select>
                    </div>
                  </div>
                </div>
        ...
        <!-- country item -->
        <div id="countriesContainer" class="container-xxl py-5">
      </div>
  ...
  <script>
    function fetchPlaces() {
      ...
      if (countryId) {
        // Make an AJAX request to the server to get places for the selected country
        $.ajax({
          url: 'fetch_places.php', // PHP file that will fetch places
          type: 'GET',
          data: { country_id: countryId },
          success: function(response) {
              $('#countriesContainer').html(response); // Display places
          },
          error: function() {
          ...
          $('#countriesContainer').html(''); // Clear places if no country selected
      }
    }
  </script>
  </body>
